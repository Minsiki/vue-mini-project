        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr :key="i" v-for="(product, i) in productList">
                    ...
                    <td>
                        <button type="button" class="btn btn-info me-1" @click="goToImageInsert(product.id);">사진 등록</button>
                        <button type="button" class="btn btn-info me-1" @click="goToUpdate(product.id);">수정</button>
                        <button type="button" class="btn btn-info me-1" @click="deleteProduct(product.id);">삭제</button>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        deleteProduct(product_id) {
            this.$swal.fire({
                ...
                if(result.isConfirmed) {
                    ...
                    this.getProductList();
                    this.$swal.fire('삭제 되었습니다!', '', 'success');
                }
            });
        }
    }
