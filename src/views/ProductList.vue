            ...
            <div class="col-xl-3 col-lg-4 col-md-6" :key="i" v-for="(product, i) in productList">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <span class="badge bd-dark text-white mr-1">{{product.category1}}</span>
                            <span class="badge bd-dark text-white mr-1">{{product.category2}}</span>
                            <span class="badge bd-dark text-white">{{product.category3}}</span>
                        </p>
