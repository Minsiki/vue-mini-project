        ...
        <div class="row">
            <div class="col-md-5">
                <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <a class="carousel-conral-prev" href="#carouselExampleIndicators" role="button" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#carouseExampleIndicators" role="button" data-bs-slide="next">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text pb-3">
                            배송비 {{getCurrencyFormat(productDetail.delivery_price)}}원 | 도서산간(제주도) 배송비 추가 {{getCurrencyFormat(productDetail.add_delivery_price)}}원 |
                        ...
                        <div class="d-flex" justify-content-between align-items-center>
                            <div class="col-6 d-grid p-1">
                                <button type="button" class="btn btn-lg btn-dard">장바구니 담기</button>
                            </div>
                            <div class="col-6 d-grid p-1">
        ...
        calculatePrice(cnt) {
         ...
         async getProductDetail() {
             ...
             if(productDetail.length > 0) {
                 ...
                 this.totalPrice = this.productDetail.productDetail.product_price * this.total;
             }
