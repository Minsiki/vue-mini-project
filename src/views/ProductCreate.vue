...
<main class="mt-3">
    <div class="container">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" v-model="prodct.product_name">
            </div>
        </div>
        <div class="mb-3 row">
            ...
            <div class="col-md-9">
                <div class="input-group mb-3">
                    <input type="number" class="form-control" v-model="prodct.product_price">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-md-9">
                <div class="input-group mb-3">
                    <input type="number" class="form-control" v-model="prodct.delivery_price">
                    <span class="input-group-text">원</span>
                </div>
            </div>
        </div>
        <div class="mb-3 row">
            ...
            <div class="col-md-9">
                <div class="input-group mb-3">
                    <input type="number" class="form-control" v-model="prodct.add_delivery_price">
                    <span class="input-group-text">원</span>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-auto">
                        <select class="form-select" v-model="cate1" @change="changeCategory1">
                            <option :value="cate" :key="i" v-for="(cate, i) in cateogory1">{{cate}}</option>
                        </select>
                    </div>
                    <div class="col-auto">
                        <select class="form-select" v-model="cate2" @change="changeCategory2">
                            <option :value="cate" :key="i" v-for="(cate, i) in cateogory2">{{cate}}</option>
                        </select>
                    </div>
                    <div class="col-auto">
                        <select class="form-select" v-model="cate3" @change="changeCategory3">
                            <option :value="cate" :key="i" v-for="(cate, i) in cateogory3">{{cate}}</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-3 row">
            <label class="col-mb-3 col-form-label">테그</label>
            <div class="col-md-9">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-md-9">
                <div class="input-group mb-3">
                    <input type="number" class="form-control" v-model="product.outbounds_days">
...
export default {
    ...
    methods: {
        ...
        async getCategoryList() {
            let categoryList = await this.$api("/api/categyList", {});
        ...
        productInsert() {
            if(this.product.product_name === "") {
                return this.$swal("제품명을 필수 입력값입니다.");
            }
            ...
            if(this.product.outbounds_day  === "" || this.product.outbounds_day  === 0) {
            ...
            console.log(this.product.cetegory_id);
